...
totalFocusTimeElement.innerText = `${secondsToMinutes(total.focusTime)} minutos`;
totalRestTimeElement.innerText = `${secondsToMinutes(total.restTime)} minutos`;
totalCycleTimeElement.innerText = `${total.cycleCount} ciclos`;
  ...
  history.forEach((cycle) => {
    ...
    restTime.innerText = secondsToMinutes(Number(rest_time));
